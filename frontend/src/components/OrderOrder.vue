<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="RestaurantId" v-model="value.restaurantId" :editMode="editMode" :inputUI="''"/>
            <String label="RestaurantName" v-model="value.restaurantName" :editMode="editMode" :inputUI="''"/>
