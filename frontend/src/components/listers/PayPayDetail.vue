<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="PaymentMethodId" v-model="item.paymentMethodId" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="PaymentMethodName" v-model="item.paymentMethodName" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
